...
// *****************************************************************************
// *****************************************************************************
// This project is a branch of the sk1632-i2s-dma, but using another Audio DAC: Texas Instruments PCM5102.
...
void init_i2s1() {
    ...
    SPI1BRG = 9;
    SPI1CON = 0x00000060;   // Master mode, SPI ON, CKP = 1, 16-bit audio channel (for DACs with System Clock disabled [internal PLL])
