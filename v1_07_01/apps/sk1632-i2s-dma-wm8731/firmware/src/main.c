...
// *****************************************************************************
// *****************************************************************************
// This project is a branch of the sk1632-i2s-dma, but using another Audio DAC: Cirrus Logic's WM8731.
...
void init_i2s1() {
    ...
    SPI1BRG = 0;
    SPI1CON = 0x00000040; // Slave mode, SPI ON, CKP = 1, 16-bit audio channel
