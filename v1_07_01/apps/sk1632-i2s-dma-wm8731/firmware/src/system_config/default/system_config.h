...
#define SYS_PORT_B_ANSEL        0xa01f
...
#define DRV_I2S_USAGE_MODE_IDX0					DRV_I2S_MODE_SLAVE
...
#define DRV_I2S_ISR_VECTOR_IDX0					_SPI1_VECTOR
#define DRV_I2S_INT_VECTOR_IDX0					INT_VECTOR_SPI1
#define DRV_I2S_INT_PRIORITY_IDX0				INT_PRIORITY_LEVEL1
#define DRV_I2S_INT_SUB_PRIORITY_IDX0			INT_SUBPRIORITY_LEVEL0
