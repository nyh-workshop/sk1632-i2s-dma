...
unsigned long amplitude2_m = 2048;             // modulator amplitude.
...
unsigned long amplitude3_m = 2048;             // modulator amplitude.
...
unsigned long amplitude4_m = 2048;             // modulator amplitude.
...
unsigned long amplitude5_m = 2048;             // modulator amplitude.
...
unsigned long amplitude6_m = 2048;             // modulator amplitude.
long output6 = 0;                              // intermediate for channel 6 output.

unsigned int ENVELOPE_SPEED = 256;
