...
static __inline__ OSAL_CRITSECT_DATA_TYPE __attribute__((nomips16,nomicromips)) OSAL_CRIT_Enter(OSAL_CRIT_TYPE severity);
static __inline__ void __attribute__((nomips16,nomicromips)) OSAL_CRIT_Leave(OSAL_CRIT_TYPE severity, OSAL_CRITSECT_DATA_TYPE status);
 ...
 */
static OSAL_CRITSECT_DATA_TYPE __attribute__((nomips16,nomicromips,always_inline)) OSAL_CRIT_Enter(OSAL_CRIT_TYPE severity)
{
 ...
 */
static void __attribute__((nomips16,nomicromips,always_inline)) OSAL_CRIT_Leave(OSAL_CRIT_TYPE severity, OSAL_CRITSECT_DATA_TYPE status)
{
   if(severity == OSAL_CRIT_TYPE_LOW)
      return;
