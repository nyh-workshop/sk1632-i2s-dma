...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _BMX_ARB_MODE_VREG(index)

  MASKs: 
    _BMX_ARB_MODE_MASK(index)

  POSs: 
    _BMX_ARB_MODE_POS(index)

  LENs: 
    _BMX_ARB_MODE_LEN(index)
...
PLIB_TEMPLATE void BMX_ArbitrationModeSet_Default( BMX_MODULE_ID index , PLIB_BMX_ARB_MODE mode )
{
    switch (mode)
    {
        case PLIB_BMX_ARB_MODE_INST:
            _SFR_FIELD_WRITE(_BMX_ARB_MODE_VREG(index), _BMX_ARB_MODE_MASK(index),
                     _BMX_ARB_MODE_POS(index), PLIB_BMX_ARB_MODE_INST); 
            break;
        case PLIB_BMX_ARB_MODE_ROT:
            _SFR_FIELD_WRITE(_BMX_ARB_MODE_VREG(index), _BMX_ARB_MODE_MASK(index),
                     _BMX_ARB_MODE_POS(index), PLIB_BMX_ARB_MODE_ROT); 
            break;
        default:
            _SFR_FIELD_WRITE(_BMX_ARB_MODE_VREG(index), _BMX_ARB_MODE_MASK(index),
                     _BMX_ARB_MODE_POS(index), PLIB_BMX_ARB_MODE_DMA); 
    }
}
...
{
    return (PLIB_BMX_ARB_MODE)_SFR_FIELD_READ(_BMX_ARB_MODE_VREG(index), _BMX_ARB_MODE_MASK(index), 
                           _BMX_ARB_MODE_POS(index));
}
