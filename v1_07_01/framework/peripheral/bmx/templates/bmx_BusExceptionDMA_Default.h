...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _BMX_BUS_EXCEPTION_DMA_VREG(index)

  MASKs: 
    _BMX_BUS_EXCEPTION_DMA_MASK(index)

  POSs: 
    _BMX_BUS_EXCEPTION_DMA_POS(index)

  LENs: 
    _BMX_BUS_EXCEPTION_DMA_LEN(index)
...
{
    _SFR_BIT_SET(_BMX_BUS_EXCEPTION_DMA_VREG(index), _BMX_BUS_EXCEPTION_DMA_POS(index));
}
...
{
    _SFR_BIT_CLEAR(_BMX_BUS_EXCEPTION_DMA_VREG(index), _BMX_BUS_EXCEPTION_DMA_POS(index));
}
