...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _BMX_BUS_EXCEPTION_IXI_VREG(index)

  MASKs: 
    _BMX_BUS_EXCEPTION_IXI_MASK(index)

  POSs: 
    _BMX_BUS_EXCEPTION_IXI_POS(index)

  LENs: 
    _BMX_BUS_EXCEPTION_IXI_LEN(index)
...
{
    _SFR_BIT_SET(_BMX_BUS_EXCEPTION_IXI_VREG(index), _BMX_BUS_EXCEPTION_IXI_POS(index));
}
...
{
    _SFR_BIT_CLEAR(_BMX_BUS_EXCEPTION_IXI_VREG(index), _BMX_BUS_EXCEPTION_IXI_POS(index));
}
