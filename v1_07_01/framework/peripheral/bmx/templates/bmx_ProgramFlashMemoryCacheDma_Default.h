...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _BMX_PFM_CACHE_DMA_VREG(index)

  MASKs: 
    _BMX_PFM_CACHE_DMA_MASK(index)

  POSs: 
    _BMX_PFM_CACHE_DMA_POS(index)

  LENs: 
    _BMX_PFM_CACHE_DMA_LEN(index)
...
{
    _SFR_BIT_SET(_BMX_PFM_CACHE_DMA_VREG(index), _BMX_PFM_CACHE_DMA_POS(index));
}
...
{
    _SFR_BIT_CLEAR(_BMX_PFM_CACHE_DMA_VREG(index), _BMX_PFM_CACHE_DMA_POS(index)); 
}
