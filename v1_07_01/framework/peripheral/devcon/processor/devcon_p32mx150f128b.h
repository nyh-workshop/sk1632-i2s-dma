...
#ifndef _DEVCON_P32MX150F128B_H
#define _DEVCON_P32MX150F128B_H
...
PLIB_INLINE SFR_TYPE* _DEVCON_PPS_LOCK_MX_VREG(DEVCON_MODULE_ID i)
{
    switch (i) {
        case DEVCON_ID_0 :
            return &CFGCON;
...
PLIB_INLINE SFR_TYPE* _DEVCON_PMD_LOCK_MX_VREG(DEVCON_MODULE_ID i)
{
    switch (i) {
        case DEVCON_ID_0 :
            return &CFGCON;
...
PLIB_INLINE SFR_DATA _DEVCON_PPS_LOCK_MX_MASK(DEVCON_MODULE_ID i)
{
    switch (i) {
        case DEVCON_ID_0 :
...
PLIB_INLINE SFR_DATA _DEVCON_PMD_LOCK_MX_MASK(DEVCON_MODULE_ID i)
{
    switch (i) {
        case DEVCON_ID_0 :
...
PLIB_INLINE SFR_DATA _DEVCON_PPS_LOCK_MX_POS(DEVCON_MODULE_ID i)
{
    switch (i) {
        case DEVCON_ID_0 :
...
PLIB_INLINE SFR_DATA _DEVCON_PMD_LOCK_MX_POS(DEVCON_MODULE_ID i)
{
    switch (i) {
        case DEVCON_ID_0 :
...
PLIB_INLINE SFR_DATA _DEVCON_PPS_LOCK_MX_LEN(DEVCON_MODULE_ID i)
{
    switch (i) {
        case DEVCON_ID_0 :
...
PLIB_INLINE SFR_DATA _DEVCON_PMD_LOCK_MX_LEN(DEVCON_MODULE_ID i)
{
    switch (i) {
        case DEVCON_ID_0 :
...
#include "../templates/devcon_DeviceRegsLockUnlock_PIC32MX.h"
...
#include "../templates/devcon_TraceOutput_Unsupported.h"
...
PLIB_INLINE_API void PLIB_DEVCON_DeviceRegistersLock(DEVCON_MODULE_ID index, DEVCON_REGISTER_SET registersToLock)
{
    switch (index) {
        case DEVCON_ID_0 :
            DEVCON_DeviceRegistersLock_PIC32MX(index, registersToLock);
            break;
        case DEVCON_NUMBER_OF_MODULES :
        default :
            break;
...
PLIB_INLINE_API void PLIB_DEVCON_DeviceRegistersUnlock(DEVCON_MODULE_ID index, DEVCON_REGISTER_SET registersToLock)
{
    switch (index) {
        case DEVCON_ID_0 :
            DEVCON_DeviceRegistersUnlock_PIC32MX(index, registersToLock);
            break;
        case DEVCON_NUMBER_OF_MODULES :
        default :
            break;
...
PLIB_INLINE_API bool PLIB_DEVCON_ExistsDeviceRegsLockUnlock(DEVCON_MODULE_ID index)
{
    switch (index) {
        case DEVCON_ID_0 :
            return DEVCON_ExistsDeviceRegsLockUnlock_PIC32MX(index);
        case DEVCON_NUMBER_OF_MODULES :
        default :
            return (bool)0;
    }
...
PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_DEVCON_TraceOutputEnable(DEVCON_MODULE_ID index)
{
    switch (index) {
        case DEVCON_ID_0 :
            DEVCON_TraceOutputEnable_Unsupported(index);
            break;
        case DEVCON_NUMBER_OF_MODULES :
        default :
            break;
...
PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_DEVCON_TraceOutputDisable(DEVCON_MODULE_ID index)
{
    switch (index) {
        case DEVCON_ID_0 :
            DEVCON_TraceOutputDisable_Unsupported(index);
            break;
        case DEVCON_NUMBER_OF_MODULES :
        default :
            break;
...
PLIB_INLINE_API bool PLIB_DEVCON_ExistsTraceOutput(DEVCON_MODULE_ID index)
{
    switch (index) {
        case DEVCON_ID_0 :
            return DEVCON_ExistsTraceOutput_Unsupported(index);
        case DEVCON_NUMBER_OF_MODULES :
        default :
            return (bool)0;
    }
