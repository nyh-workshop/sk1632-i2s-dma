...
{
    _SFR_BIT_WRITE(_DEVCON_JTAG_TDO_USE_ENABLE_VREG(index),_DEVCON_JTAG_TDO_USE_ENABLE_POS(index),1);
}
...
{
    _SFR_BIT_WRITE(_DEVCON_JTAG_TDO_USE_ENABLE_VREG(index),_DEVCON_JTAG_TDO_USE_ENABLE_POS(index),0);
}
