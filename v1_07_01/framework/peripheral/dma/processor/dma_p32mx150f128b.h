...
#ifndef _DMA_P32MX150F128B_H
#define _DMA_P32MX150F128B_H
...
typedef enum {
    ...
    DMA_CHANNEL_0_INT_SOURCE = 60,
    DMA_CHANNEL_1_INT_SOURCE = 61,
    DMA_CHANNEL_2_INT_SOURCE = 62,
    DMA_CHANNEL_3_INT_SOURCE = 63
...
typedef enum {
    ...
    DMA_TRIGGER_SPI_1_ERROR = 36,
    DMA_TRIGGER_SPI_1_RECEIVE = 37,
    DMA_TRIGGER_SPI_1_TRANSMIT = 38,
    DMA_TRIGGER_SPI_2_ERROR = 50,
    DMA_TRIGGER_SPI_2_RECEIVE = 51,
    DMA_TRIGGER_SPI_2_TRANSMIT = 52,
    DMA_TRIGGER_I2C_1_ERROR = 42,
    DMA_TRIGGER_I2C_1_SLAVE = 43,
    DMA_TRIGGER_I2C_1_MASTER = 44,
    DMA_TRIGGER_I2C_2_ERROR = 56,
    DMA_TRIGGER_I2C_2_SLAVE = 57,
    DMA_TRIGGER_I2C_2_MASTER = 58,
    DMA_TRIGGER_USART_1_ERROR = 39,
    DMA_TRIGGER_USART_1_RECEIVE = 40,
    DMA_TRIGGER_USART_1_TRANSMIT = 41,
    DMA_TRIGGER_USART_2_ERROR = 53,
    DMA_TRIGGER_USART_2_RECEIVE = 54,
    DMA_TRIGGER_USART_2_TRANSMIT = 55,
    DMA_TRIGGER_CHANGE_NOTICE_A = 45,
    DMA_TRIGGER_CHANGE_NOTICE_B = 46,
    DMA_TRIGGER_CHANGE_NOTICE_C = 47,
    DMA_TRIGGER_DMA_0 = 60,
    DMA_TRIGGER_DMA_1 = 61,
    DMA_TRIGGER_DMA_2 = 62,
    DMA_TRIGGER_DMA_3 = 63,
    DMA_TRIGGER_COMPARATOR_1 = 32,
    DMA_TRIGGER_COMPARATOR_2 = 33,
    DMA_TRIGGER_COMPARATOR_3 = 34,
    DMA_TRIGGER_ADC_1 = 28,
    DMA_TRIGGER_PARALLEL_PORT = 48,
    DMA_TRIGGER_CLOCK_MONITOR = 29,
    DMA_TRIGGER_RTCC = 30,
    DMA_TRIGGER_FLASH_CONTROL = 31,
    DMA_TRIGGER_USB_1 = 35,
    DMA_TRIGGER_PARALLEL_PORT_ERROR = 49,
    DMA_TRIGGER_CTMU = 59
