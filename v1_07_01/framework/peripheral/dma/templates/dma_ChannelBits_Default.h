...
/* Routines available for accessing VREGS, MASKS, POS, LEN are
  ...
  VREGs:
    _DMA_CHANNELBITS_VREG(index)

  MASKs:
    _DMA_CHANNELBITS_MASK(index)

  POSs:
    _DMA_CHANNELBITS_POS(index)

  LENs:
    _DMA_CHANNELBITS_LEN(index)
...
{
    return _SFR_FIELD_READ (_DMA_CHANNELBITS_VREG(index),
                            _DMA_CHANNELBITS_MASK(index),
                            _DMA_CHANNELBITS_POS(index));
}
