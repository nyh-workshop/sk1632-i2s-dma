...
PLIB_TEMPLATE void DMA_ChannelXPatternLengthSet_Unsupported( DMA_MODULE_ID index , DMA_CHANNEL dmaChannel , DMA_PATTERN_LENGTH patternLen )
{
...
PLIB_TEMPLATE DMA_PATTERN_LENGTH DMA_ChannelXPatternLengthGet_Unsupported( DMA_MODULE_ID index , DMA_CHANNEL dmaChannel )
{
