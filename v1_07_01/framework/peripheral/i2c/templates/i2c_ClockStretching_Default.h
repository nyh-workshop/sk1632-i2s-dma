...
#ifndef _I2C_CLOCKSTRETCHING_DEFAULT_H
#define _I2C_CLOCKSTRETCHING_DEFAULT_H

//******************************************************************************
/* Routines available for accessing VREGS, MASKS, POS, LEN are 

  VREGs: 
    _I2C_CLOCK_STRETCH_ENABLE_VREG(index)

  MASKs: 
    _I2C_CLOCK_STRETCH_ENABLE_MASK(index)

  POSs: 
    _I2C_CLOCK_STRETCH_ENABLE_POS(index)

  LENs: 
    _I2C_CLOCK_STRETCH_ENABLE_LEN(index)
...
{
    _SFR_BIT_SET(_I2C_CLOCK_STRETCH_ENABLE_VREG(index),
                       _I2C_CLOCK_STRETCH_ENABLE_POS(index) );
}
...
{
    _SFR_BIT_CLEAR(_I2C_CLOCK_STRETCH_ENABLE_VREG(index),
                       _I2C_CLOCK_STRETCH_ENABLE_POS(index) );
}


//******************************************************************************
/* Function :  I2C_ExistsClockStretching_Default

  Summary:
    Implements Default variant of PLIB_I2C_ExistsClockStretching

  Description:
    This template implements the Default variant of the PLIB_I2C_ExistsClockStretching function.
*/

#define PLIB_I2C_ExistsClockStretching PLIB_I2C_ExistsClockStretching
PLIB_TEMPLATE bool I2C_ExistsClockStretching_Default( I2C_MODULE_ID index )
{
    return true;
}


#endif /*_I2C_CLOCKSTRETCHING_DEFAULT_H*/
