...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _I2C_TRANSMITTER_READY_VREG(index)

  MASKs: 
    _I2C_TRANSMITTER_READY_MASK(index)

  POSs: 
    _I2C_TRANSMITTER_READY_POS(index)

  LENs: 
    _I2C_TRANSMITTER_READY_LEN(index)
...
{
    return _SFR_BIT_READ(_I2C_TRANSMITTER_READY_VREG(index),
                             _I2C_TRANSMITTER_READY_POS(index) );
}
