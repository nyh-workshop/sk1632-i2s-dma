...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _INT_LATEST_INT_PRIORITY_VREG(index)

  MASKs: 
    _INT_LATEST_INT_PRIORITY_MASK(index)

  POSs: 
    _INT_LATEST_INT_PRIORITY_POS(index)

  LENs: 
    _INT_LATEST_INT_PRIORITY_LEN(index)
...
{
    return (INT_PRIORITY_LEVEL)(_SFR_FIELD_READ(_INT_LATEST_INT_PRIORITY_VREG(index),_INT_LATEST_INT_PRIORITY_MASK(index),_INT_LATEST_INT_PRIORITY_POS(index)));
}
