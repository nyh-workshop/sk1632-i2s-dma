...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _INT_SHADOW_SET_VREG(index)

  MASKs: 
    _INT_SHADOW_SET_MASK(index)

  POSs: 
    _INT_SHADOW_SET_POS(index)

  LENs: 
    _INT_SHADOW_SET_LEN(index)
...
{
    _SFR_BIT_CLEAR(_INT_SHADOW_SET_VREG(index),_INT_SHADOW_SET_POS(index));
}
...
{
    _SFR_BIT_SET(_INT_SHADOW_SET_VREG(index),_INT_SHADOW_SET_POS(index));
}
