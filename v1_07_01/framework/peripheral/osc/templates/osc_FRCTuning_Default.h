...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _OSC_OSC_FRC_TUNING_VREG(index)

  MASKs: 
    _OSC_OSC_FRC_TUNING_MASK(index)

  POSs: 
    _OSC_OSC_FRC_TUNING_POS(index)

  LENs: 
    _OSC_OSC_FRC_TUNING_LEN(index)
...
{
    _SFR_FIELD_WRITE(_OSC_OSC_FRC_TUNING_VREG(index),
                     _OSC_OSC_FRC_TUNING_MASK(index),
                     _OSC_OSC_FRC_TUNING_POS(index) ,
                     tuningValue );
}
