...
{
    _SFR_FIELD_WRITE(_OSC_OSC_SELECT_VREG(index),
                     _OSC_OSC_SELECT_MASK(index),
                     _OSC_OSC_SELECT_POS(index) ,
                     newOsc);
    _SFR_BIT_SET(_OSC_OSC_SWITCH_INIT_VREG(index),
                     _OSC_OSC_SWITCH_INIT_POS(index) );
