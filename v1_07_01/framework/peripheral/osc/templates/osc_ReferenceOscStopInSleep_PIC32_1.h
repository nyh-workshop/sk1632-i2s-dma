...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _OSC_REF_STOPINSLEEP_VREG(index)

  MASKs: 
    _OSC_REF_STOPINSLEEP_MASK(index)

  POSs: 
    _OSC_REF_STOPINSLEEP_POS(index)

  LENs: 
    _OSC_REF_STOPINSLEEP_LEN(index)
...
{
    _SFR_BIT_CLEAR(_OSC_REF_STOPINSLEEP_VREG(index),
                     _OSC_REF_STOPINSLEEP_POS(index) );
}
...
{
    _SFR_BIT_SET(_OSC_REF_STOPINSLEEP_VREG(index),
                     _OSC_REF_STOPINSLEEP_POS(index) );
}
...
{
    return (!_SFR_BIT_READ(_OSC_REF_STOPINSLEEP_VREG(index),
                     _OSC_REF_STOPINSLEEP_POS(index) ));
}
