...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _SPI_MODE32_COMMUNICATION_WIDTH_PIC32_VREG(index)
    _SPI_MODE16_COMMUNICATION_WIDTH_PIC32_VREG(index)

  MASKs: 
    _SPI_MODE32_COMMUNICATION_WIDTH_PIC32_MASK(index)
    _SPI_MODE16_COMMUNICATION_WIDTH_PIC32_MASK(index)
  ...
  LENs: 
    _SPI_MODE32_COMMUNICATION_WIDTH_PIC32_LEN(index)
    _SPI_MODE16_COMMUNICATION_WIDTH_PIC32_LEN(index)
