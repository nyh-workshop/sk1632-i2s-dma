...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _SPI_FIFO_CONTROL_VREG(index)

  MASKs: 
    _SPI_FIFO_CONTROL_MASK(index)

  POSs: 
    _SPI_FIFO_CONTROL_POS(index)

  LENs: 
    _SPI_FIFO_CONTROL_LEN(index)
...
{
    _SFR_BIT_SET( _SPI_FIFO_CONTROL_VREG( index ),
                  _SPI_FIFO_CONTROL_POS( index ) );
}
...
{
    _SFR_BIT_CLEAR( _SPI_FIFO_CONTROL_VREG( index ),
                    _SPI_FIFO_CONTROL_POS( index ) );
}
