...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _SPI_FIFO_REGISTER_EMPTY_STATUS_VREG(index)

  MASKs: 
    _SPI_FIFO_REGISTER_EMPTY_STATUS_MASK(index)

  POSs: 
    _SPI_FIFO_REGISTER_EMPTY_STATUS_POS(index)

  LENs: 
    _SPI_FIFO_REGISTER_EMPTY_STATUS_LEN(index)
...
{
    return( _SFR_BIT_READ( _SPI_FIFO_REGISTER_EMPTY_STATUS_VREG( index ),
                           _SPI_FIFO_REGISTER_EMPTY_STATUS_POS( index ) ) );
}
