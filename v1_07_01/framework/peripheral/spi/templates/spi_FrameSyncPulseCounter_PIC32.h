...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _SPI_FRAME_SYNC_PULSE_COUNTER_PIC32_VREG(index)

  MASKs: 
    _SPI_FRAME_SYNC_PULSE_COUNTER_PIC32_MASK(index)

  POSs: 
    _SPI_FRAME_SYNC_PULSE_COUNTER_PIC32_POS(index)

  LENs: 
    _SPI_FRAME_SYNC_PULSE_COUNTER_PIC32_LEN(index)
...
{
    _SFR_FIELD_WRITE( _SPI_FRAME_SYNC_PULSE_COUNTER_PIC32_VREG( index ),
                      _SPI_FRAME_SYNC_PULSE_COUNTER_PIC32_MASK( index ),
                      _SPI_FRAME_SYNC_PULSE_COUNTER_PIC32_POS( index ),
                      pulse );
}
