    ...
    switch( pin )
    {
        ...
        case SPI_PIN_DATA_OUT:
                _SFR_BIT_CLEAR( _SPI_PIN_CONTROL_SDO_VREG( index ),
                                _SPI_PIN_CONTROL_SDO_POS( index ) );
            break;
        case SPI_PIN_DATA_IN:
                _SFR_BIT_CLEAR( _SPI_PIN_CONTROL_SDI_VREG( index ),
                                _SPI_PIN_CONTROL_SDI_POS( index ) );
            break;			
        default:
            break;
...
PLIB_TEMPLATE void SPI_PinDisable_PIC32( SPI_MODULE_ID index , SPI_PIN pin )
{
    switch( pin )
    {
        ...
        case SPI_PIN_DATA_OUT:
            ...
            break;
        case SPI_PIN_DATA_IN:
                _SFR_BIT_SET( _SPI_PIN_CONTROL_SDI_VREG( index ),
                                _SPI_PIN_CONTROL_SDI_POS( index ) );
            break;			
        default:
            break;
