...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _SPI_READ_DATA_SIGN_STATUS_VREG(index)

  MASKs: 
    _SPI_READ_DATA_SIGN_STATUS_MASK(index)

  POSs: 
    _SPI_READ_DATA_SIGN_STATUS_POS(index)

  LENs: 
    _SPI_READ_DATA_SIGN_STATUS_LEN(index)
...
{
   return( _SFR_BIT_READ( _SPI_READ_DATA_SIGN_STATUS_VREG( index ),
                           _SPI_READ_DATA_SIGN_STATUS_POS( index ) ) );
}
