...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _SPI_STOP_IN_IDLE_VREG(index)

  MASKs: 
    _SPI_STOP_IN_IDLE_MASK(index)

  POSs: 
    _SPI_STOP_IN_IDLE_POS(index)

  LENs: 
    _SPI_STOP_IN_IDLE_LEN(index)
...
{
    _SFR_BIT_SET(_SPI_STOP_IN_IDLE_VREG(index),
                 _SPI_STOP_IN_IDLE_POS(index) );
}
...
{
    _SFR_BIT_CLEAR(_SPI_STOP_IN_IDLE_VREG(index),
                   _SPI_STOP_IN_IDLE_POS(index) );
}
